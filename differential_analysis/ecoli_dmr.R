...
dmr_methyl_phase_4mC <- fread("ecoli_exp_sta_dmr_4mc.tsv",sep="\t", header=TRUE)
dmr_methyl_phase_5mC <- fread("ecoli_exp_sta_dmr_5mc.tsv",sep="\t", header=TRUE)
dmr_methyl_phase_6mA <- fread("ecoli_exp_sta_dmr_6ma.tsv",sep="\t", header=TRUE)
...
ecoli_m4C_position_clean <- position_clean(ecoli_m4C_position, dmr_methyl_phase_4mC)
ecoli_m5C_position_clean <- position_clean(ecoli_m5C_position, dmr_methyl_phase_5mC)
ecoli_m6A_position_clean <- position_clean(ecoli_m6A_position, dmr_methyl_phase_6mA)
...
promoter_m6a_position_differential <- differntial_position_replicate(promoter_methyl_from_differential_m6A,
                                                                     position_clean_modified_code(ecoli_m6A_position, "a", "m6A"), "promoter")

gene_body_m6a_position_differential <- differntial_position_replicate(gene_body_methyl_from_differential_m6A,
                                                                      position_clean_modified_code(ecoli_m6A_position, "a", "m6A"), "gene_body")
...
none_regulatory_m5c_position_differential <- differntial_position_replicate_none_regulatory(gene_body_methyl_from_differential_m5C,
                                                                                            position_clean_modified_code(ecoli_m5C_position, "m", "m5C"), "neither")
